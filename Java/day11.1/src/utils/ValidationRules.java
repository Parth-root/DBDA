...
public class ValidationRules {
	...
	public static Vehicle validateAllInputs(String chasisNo, String vehicleColor, double basePrice,
			String manufactureDate, String company, ArrayList<Vehicle> vehicles) throws InvalidVehicleDetailsException {
...
//add a static method to chk for dup chasis no
	public static String validateChasisNo(ArrayList<Vehicle> vehicles, String newChasis) throws InvalidVehicleDetailsException {
...
//		return newChasis;
		//use contains method to chk if vehicle with the same chasis no exists !
		if(vehicles.contains(v1))
			throw new InvalidVehicleDetailsException("Dup chasis no !!!!!!");
		return newChasis;
	}
